...
def routes_snap(
    ...
    Для лучшей точности передавайте не только новую линию, а отрезок маршрута
    с контекстом: рекомендуется до 10 линий в одном `MultiLineString`, включая
    9 уже известных линий и 1 новую линию.
